...
<main>
    ...
    padding: 10px 20px 10px 20px;opacity: 1">
                <div class="input-group">
                    <input board-label="title" type="text"
                           value="<?= !empty($board_labels['title']) ? $board_labels['title'] : 'Kinyarwanda Proficiency Program Cohort S’2022' ?>"
                           class="form-control" placeholder="">
                    <span class="input-group-btn">
                            <button class="btn btn-info board-label" board-label-for="title"
                                    type="button">Save Label</button>
                        </span>
                </div>

                <small class="color-white" style="opacity: 1">

                    <div class="input-group">
                        <input board-label="sub_title" type="text"
                               value="<?= !empty($board_labels['sub_title']) ? $board_labels['sub_title'] : 'Gusoma Education - School of Kinyarwanda' ?>"
                               class="form-control" placeholder="">
                        <span class="input-group-btn">
                            <button class="btn btn-info board-label" board-label-for="sub_title" type="button">Save Label</button>
                        </span>
                    </div>
                </small>
				<?php if (isset($last_pub)): ?>
                    <small class="pull-right color-white" style=" color: #fff;;">
                        ...
                        <br>
                        <b class="color-white">Updated By:</b> <i
                                        ...
                                        <h5 class="card-title fw-400 font-weight-bold text-uppercase text-center">
                                            <div class="input-group">
                                                <input board-label="this_week_lesson" type="text"
                                                       ...
                                                       class="form-control" placeholder="">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="this_week_lesson" type="button">Save Label</button>
                                                </span>
                                            </div>
                                            <hr>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    ...
                                                    <div class="input-group">
                                                        <input board-label="this_week_bl" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="this_week_bl" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    <div class="input-group">
                                                        <input board-label="this_week_al" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="this_week_al" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    <div class="input-group">
                                                        <input board-label="this_week_ann" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="this_week_ann" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                        ...
                                        <h5 class="card-title fw-400 font-weight-bold text-uppercase text-center">
                                            <div class="input-group">
                                                <input board-label="weekly_tasks" type="text"
                                                       ...
                                                       class="form-control" placeholder="">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="weekly_tasks" type="button">Save Label</button>
                                                </span>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-group mb-4">
                                                <div class="d-flex  gap-items-2 gap-y mt-16 justify-content-around">
                                                    ...
                                                    <button section="weekly_tasks" component="calendar"
                                                            ...
                                                            title="Connecting google" type="button">Send to your
                                                        calendar
                                                    </button>
                                                </div>
                                            </div>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    ...
                                                    <div class="input-group">
                                                        <input board-label="weekly_tasks_bl" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="weekly_tasks_bl" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    <div class="input-group">
                                                        <input board-label="weekly_tasks_al" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="weekly_tasks_al" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    <div class="input-group">
                                                        <input board-label="weekly_tasks_ann" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="weekly_tasks_ann" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                        ...
                                        <h5 class="card-title fw-400 font-weight-bold text-uppercase text-center">
                                                ...
                                                <div class="input-group">
                                                    <input board-label="group_work" type="text"
                                                           ...
                                                           class="form-control" placeholder="">
                                                    <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="group_work" type="button">Save Label</button>
                                                </span>
                                                </div>
                                                ...
                                                <label class="text-dark text-uppercase font-weight-bold">
                                                    <div class="input-group">
                                                        <input board-label="group_work_tw" type="text"
                                                               ...
                                                               class="form-control" placeholder="">
                                                        <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="group_work_tw" type="button">Save Label</button>
                                                </span>
                                                    </div>
                                                </label>
                                        ...
                                        <h5 class="card-title fw-400 font-weight-bold text-uppercase text-center">
                                            <div class="input-group">
                                                <input board-label="course_materials" type="text"
                                                       ...
                                                       class="form-control" placeholder="">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-info board-label" board-label-for="course_materials" type="button">Save Label</button>
                                                </span>
                                            </div>
                                            <hr>
